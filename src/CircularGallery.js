...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    // Make the card horizontally rectangular
...
class App {
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(items, bend, textColor, borderRadius, font, cardWidth, cardHeight);
    this.update();
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font, cardWidth, cardHeight) {
    const defaultItems = [
